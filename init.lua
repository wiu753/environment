-- TODO: Move lines up and down using alt + hjkl
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Jump to the definition of the word under your cursor using Omnisharp Extended.
          -- map('gG', ":lua require('omnisharp_extended').lsp_definition()<cr>", '[G]oto Definition Omnisharp')
          ...
          -- Find reference for the word under your cursor using Omnisharp Extended.
          -- map('gR', ":lua require('omnisharp_extended').telescope_lsp_references()<cr>", '[G]oto [R]eferences Omnisharp')
